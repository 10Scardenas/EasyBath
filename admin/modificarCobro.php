<?php
    ...
    if(isset($_GET['codigo'])){
        $codigo = $_GET['codigo'];
        $query = "SELECT * FROM cobros WHERE id_cobro = $codigo";
        $result = mysqli_query($con, $query);
        if(mysqli_num_rows($result) == 1){
            $row = mysqli_fetch_array($result);
            $id_banio = $row['id_banio'];
            $empresa = $row['empresa'];
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      <!-- Pagina heading -->
      <h1 class="h3 mb-4 text-gray-800">Modificar Cobro <small class="d-inline text-muted">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <div class="card mb-4 py-3 border-top-info">
            <div class="card-body">
              <form id="updateUserForm" class="needs-validation" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" action="editarCobro.php?codigo=<?php echo $_GET['codigo']; ?>" method="POST" novalidate>
               

              
                <!-- Nuevo Campo-->
                <div class="form-group">
                  <label for="id_banio">Baño</label>
                  <input type="text" class="form-control" id="id_banio" name="id_banio" required>
                ...
                <div class="form-group">
                  ...
                  <input name="monto_mensual" type="text" class="form-control" id="passwordUser" placeholder="Monto iva incluido" required>
                  <div class="invalid-feedback">
                    Invalido.
                  </div>
                </div>
