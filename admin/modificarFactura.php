<?php
    ...
    if(isset($_GET['codigo'])){
        $codigo = $_GET['codigo'];
        $query = "SELECT * FROM renta WHERE id_renta = $codigo";
        $result = mysqli_query($con, $query);
        if(mysqli_num_rows($result) == 1){
            $row = mysqli_fetch_array($result);
            $control_mensual = $row['control_mensual'];
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      <!-- Pagina heading -->
      <h1 class="h3 mb-4 text-gray-800">Modificar Estado <small class="d-inline text-muted">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <div class="card mb-4 py-3 border-top-info">
            <div class="card-body">
              <form id="updateUserForm" class="needs-validation" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" action="editFactura.php?codigo=<?php echo $_GET['codigo']; ?>" method="POST" novalidate>
               

                <!-- Nuevo Campo-->
                <div class="form-group mb-3">
                  <label for="control_mensual">Estado</label>
                  <select class="custom-select d-block w-100" id="control_mensual" name="control_mensual" required>
