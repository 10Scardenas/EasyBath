  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Lista de Baños</h1>
        </div>
        ...
        <div class="col-12">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Añadir Baño</h6>
              <div class="dropdown no-arrow show">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-156px, -155px, 0px);">
                  <div class="dropdown-header">Opciones:</div>
                    <a class="dropdown-item" href="CrearBanio.php">Añadir nuevo Baño</a>
                  <div class="dropdown-divider"></div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body" action="savetask.php" method="POST">
              <div class="table-responsive">
                <table class="table table-bordered" id="dtBasicExample" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                      $sql="SELECT id_banio,ciudad, estado, fecha_inicio FROM banio" ;
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                            <a href ="modificarBanio.php?codigo=<?php echo $fila['id_banio']?>" class="btn btn-primary"> 
