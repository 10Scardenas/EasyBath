...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      <!-- Pagina heading -->
      <h1 class="h3 mb-4 text-info 800">Crear Gasto </h1>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <div class="card mb-4 py-3 border-top-info">
            <div class="card-body">
              <form id="createUserForm" class="needs-validation" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" action="agregarGasto.php" method="POST" novalidate>
                <h5 class="mb-3 font-weight-bold text-info">Agregar Gasto</h5>
                ...
                <div class="form-group">
                  ...
                  <input name="concepto" type="text" class="form-control" id="concepto" required>
                ...
                <div class="form-group mb-3">
                  ...
                  <select class="custom-select d-block w-100" id="tipo_gasto" name="tipo_gasto" required>
                ...
                <div class="form-group">
                  ...
                  <input name="fecha_gasto" type="date" class="form-control" id="fecha_gasto" placeholder="Monto del baño" required>
                  <div class="invalid-feedback">
                    Invalido.
                  </div>
                </div>
                ...
                <div class="form-group mb-3">
                  ...
                  <select class="custom-select d-block w-100" id="forma_pago" name="forma_pago" required>
                ...
                <div class="pt-2">
                  <button name ="agregarGasto" value="agregarGasto" class="btn btn-info btn-lg font-weight-bold" type="submit">Agregar Gasto</button>
                </div>
              </form>
            </div>
          </div>
