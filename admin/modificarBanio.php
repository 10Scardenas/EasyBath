<?php
    ...
    if(isset($_GET['codigo'])){
        $codigo = $_GET['codigo'];
        $query = "SELECT * FROM banio WHERE id_banio = $codigo";
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      <!-- Pagina heading -->
      <h1 class="h3 mb-4 text-gray-800">Modificar Baño <small class="d-inline text-muted">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <div class="card mb-4 py-3 border-top-info">
            <div class="card-body">
              <form id="updateUserForm" class="needs-validation" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" action="editBanio.php?codigo=<?php echo $_GET['codigo']; ?>" method="POST" novalidate>
