...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      <!-- Pagina heading -->
      <h1 class="h3 mb-4 text-info 800">Crear Baño </h1>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <div class="card mb-4 py-3 border-top-info">
            <div class="card-body">
              <form id="createUserForm" class="needs-validation" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" action="agregarBanio.php" method="POST" novalidate>
                <h5 class="mb-3 font-weight-bold text-info">Agregar Baño</h5>

                <!-- Nuevo Campo -->
                <div class="form-group">
                  <label for="nombreUsuario">Ciudad</label>
                  <input name="ciudad" type="text" class="form-control" id="nombreUsuario" placeholder="" required>
                ...
                <div class="pt-2">
                  <button name ="agregarBanio" value="agregarBanio" class="btn btn-info btn-lg font-weight-bold" type="submit">Agregar Baño</button>
                </div>
              </form>
            </div>
          </div>
